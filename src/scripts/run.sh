...
python runner.py --models mobilenetv3 efficientnet --mode train --epochs 60 --lr 1e-4 --batch 32 --workers 8 --patience 10 --min_loss 0.4000 --weighted_loss
python runner.py --models cnn --mode train --epochs 70 --lr 1e-3 --batch 32 --workers 8 --patience 10 --min_loss 0.4000 --weighted_loss

# Training scripts - Without RoI, with Weighted sampling
python runner.py --models mobilenetv3 efficientnet --mode train --epochs 60 --lr 1e-4 --batch 32 --workers 8 --patience 10 --min_loss 0.4000 --weighted_sampling
python runner.py --models cnn --mode train --epochs 70 --lr 1e-3 --batch 32 --workers 8 --patience 10 --min_loss 0.4000 --weighted_sampling
